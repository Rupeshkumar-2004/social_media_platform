    ...
    printf("9. Logout\n");
        ...
        switch(choice){
            ...
            case 5: {
                ...
                if(!c){ 
                    printf("Invalid comment selection.\n");
                    break;
                }
                getchar();
            ...
            case 6: {
                ...
                while(1){
                    ...
                    if(act==1){ 
                        ...
                        int ci =0;
                        if(!c){ 
                            printf("No comments to like.\n"); 
                            continue;
                        }
                        while(c){ 
                            printf("[%d] %s: %s (Likes: %d)\n", ci,c->username,c->content,c->likes);
                            c = c->next;
                            ci++; 
                        }
                        int pickc; 
                        printf("Enter comment index to like: ");
                        scanf("%d",&pickc);
                        c = chosen->comments; 
                        ci = 0; 
                        while(c && ci < pickc){ 
                        ...
                        int ci = 0;
                        if(!c){ 
                            printf("No comments to reply to.\n");
                            continue;
                        }
                        while(c){ 
                            printf("[%d] %s: %s\n",ci,c->username,c->content);
                            c = c->next;
                            ci++;
                        }
                        int pickc;
                        ...
                        int ci = 0;
                        if(!c){
                            printf("No comments/replies to like.\n");
                            continue;
                        }
                        while(c){
                            ...
                            int ri =0; 
                            while(r){ 
                                printf("  Reply [%d] %s: %s (Likes: %d)\n",ri,r->username,r->content,r->likes); 
                                r =r->next; 
                                ri++; 
                            } 
                            c =c->next;
                        ...
                        int pickc;
                        printf("Enter comment index which contains the reply: ");
                        scanf("%d",&pickc);
                        Comment* cc =chosen->comments;
                        int ci2 =0;
                        while(cc && ci2<pickc){ 
                            cc =cc->next;
                            ci2++; 
                        ...
                        Reply* rr =cc->replies;
                        if(!rr){
                            printf("No replies to like under that comment.\n"); 
                            continue; 
                        }
                        int pickr; 
                        printf("Enter reply index to like: "); 
                        scanf("%d",&pickr);
                        int ri2 = 0;
                        while(rr && ri2<pickr){ 
                            rr =rr->next; 
                        ...
                        if(!rr){ 
                            printf("Invalid reply selection.\n"); 
                        } 
                        else{ 
                            likeReply(rr); 
                            printf("Reply liked. Likes: %d\n", rr->likes);
                        }
                    }
